...
emcc "${OBJECTS[@]}" \
  ...
  -sEXPORTED_FUNCTIONS='["_main","_malloc","_free","_prepareRomBuffer","_loadROM","_reset","_isRomLoaded","_runFrame","_runFrames","_fillAudioBuffer","_getSymbol","_setSampleRate","_savGetSize","_savGetPointer","_savUpdateChangeFlag","_savImportFromFile","_savExportToFile","_stateGetSize","_stateGetPointer","_saveStateToBuffer","_loadStateFromBuffer","_loadStateFromFile","_dbgGetLastStateChunk","_dbgGetLastStatePhase","_zlibCompress","_zlibDecompress","_pauseEmu","_isPaused","_debuggerSetEnabled","_traceSetEnabled","_traceSetPrivilegeCheck","_traceGetDepth","_dbgGetReg","_dbgSetReg","_dbgRead8","_dbgRead16","_dbgRead32","_dbgWrite8","_dbgWrite16","_dbgWrite32","_dbgDumpMemory","_dbgSetExecBreakpoint","_dbgSetReadBreakpoint","_dbgSetWriteBreakpoint","_dbgSetSpecialBreakpoint","_dbgClearBreakStatus","_dbgStep","_dbgStepOver","_dbgGetStatusJson","_dbgDisassemble","_dbgStackTrace","_dbgCallStackJson","_chtGetList","_chtAddItem","_utilStrLen","_emuSetOpt"]' \
