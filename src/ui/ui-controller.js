...
export function bindUi(context) {
    ...
    ui.stackNextCallThisDepthToolbarBtn.addEventListener("click", () => runCommand("nextCallThisDepth", { timeoutMs: 1000 }).catch((e) => log(e.message)));
    ...
    ui.stackNextCallThisDepthDebugBtn.addEventListener("click", () => runCommand("nextCallThisDepth", { timeoutMs: 1000 }).catch((e) => log(e.message)));
