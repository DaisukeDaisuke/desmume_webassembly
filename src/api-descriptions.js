export function createApiDescriptions() {
    return {
        ...
        stepOver: "記録済みactive Stack Trace laneをJS stepし、現在命令の逐次PCまで進めます。同じlaneが開始深度より浅くなるか消えた場合はroot境界で停止します。事前にStack Traceの有効化とactive frame記録が必要です。",
        ...
        nextCallThisDepth: "記録済みactive Stack Trace lane内の次の直接関数呼び出しまで進めます。別laneの深度変化は無視し、開始laneが浅くなるか消えた場合はroot境界で停止します。",
